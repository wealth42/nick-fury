...
*   HTML & CSS: 
    *   Create upto the mark website based on the user story selected.
    *   Design and Organise your webpage to depict the objectives of the story selected.
    *   Integrate CSS to add styling to the webpage.(Frameworks can be used)
*   View: 
...
*   Functionality(optional): 
    *   Use JavaScript to add functionality to the website.
...
For a HTML/CSS dev, this could translate to: 
    1. Creating additional functionality using JavaScript.
    2. Making sure necessary transitions are made while viewing the project of different devices.
