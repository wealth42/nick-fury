			...
			<div class="login-content">
				<div class="login-body">
					...
					<form action="" method="post">
						...
						<div class="mb-20">
							<input class="btn btn-danger submit" type="submit" name="login" value="Login"><a class="btn btn-warning" href="../"> Back to home page </a>
						</div>
					</form>
				</div>
                ...
                <?php 
                    if (isset($_POST["login"])) {
                        $count=0;
                        $res= mysqli_query($link, "select * from t_registration where username='$_POST[username]' && password= '".md5($_POST[password])."' ");
						$rej= mysqli_query($link, "select * from t_registration where username='$_POST[username]' && password= '".md5($_POST[password])."' && status= 'yes'");
